---
agent: 'agent'
description: 'Create a DOCUMENTATION.md file for the project'
---
...
6. The language must be English.
7. For bash commands, use triple backticks with "bash" for syntax highlighting and chain them with && instead of having multiple commands, which belong logically together
